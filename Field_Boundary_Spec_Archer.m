...
%This function is kinda gross but it does the job. Given a bunch of parameters, it makes a flow
%map that matches the parameters using a recursive guess-and-check algorithm
